...
// InputAction corresponds to a key or button action.
type InputAction int

// InputAction types.
const (
	Release InputAction = InputAction(glfw.Release) // The key or button was released.
	Press   InputAction = InputAction(glfw.Press)   // The key or button was pressed.
	Repeat  InputAction = InputAction(glfw.Repeat)  // The key was held down until it repeated.
)
